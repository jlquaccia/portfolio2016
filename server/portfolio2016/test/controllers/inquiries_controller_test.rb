...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { email: @inquiry.email, message: @inquiry.message, name: @inquiry.name, phone: @inquiry.phone }
    end
  ...
  test "should update inquiry" do
    patch :update, id: @inquiry, inquiry: { email: @inquiry.email, message: @inquiry.message, name: @inquiry.name, phone: @inquiry.phone }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
